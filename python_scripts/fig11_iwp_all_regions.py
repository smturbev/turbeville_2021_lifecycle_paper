...
cax.annotate("11%", xy=(3.1,0.06), xycoords="data", fontsize=17, color=color1)
cax.annotate("48%", xy=(1.7,0.06), xycoords="data", fontsize=17, color=color2)
cax.annotate("25%", xy=(-0.1,0.06), xycoords="data", fontsize=17, color=color3)
cax.annotate("15%", xy=(-1.6,0.06), xycoords="data", fontsize=17, color=color0)
nax.annotate(str(np.around(ntwp.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.06), xycoords="data", fontsize=17, color=color1)
nax.annotate(str(np.around(ntwp.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.06), xycoords="data", fontsize=17, color=color2)
nax.annotate(str(np.around(ntwp.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.06), xycoords="data", fontsize=17, color=color3)
nax.annotate(str(np.around(ntwp.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.06), xycoords="data", fontsize=17, color=color0)
fax.annotate(str(np.around(ftwp.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.06), xycoords="data", fontsize=17, color=color1)
fax.annotate(str(np.around(ftwp.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.06), xycoords="data", fontsize=17, color=color2)
fax.annotate(str(np.around(ftwp.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.06), xycoords="data", fontsize=17, color=color3)
fax.annotate(str(np.around(ftwp.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.06), xycoords="data", fontsize=17, color=color0)
iax.annotate(str(np.around(itwp.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.06), xycoords="data", fontsize=17, color=color1)
iax.annotate(str(np.around(itwp.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.06), xycoords="data", fontsize=17, color=color2)
iax.annotate(str(np.around(itwp.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.06), xycoords="data", fontsize=17, color=color3)
iax.annotate(str(np.around(itwp.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.06), xycoords="data", fontsize=17, color=color0)
sax.annotate(str(np.around(stwp.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.06), xycoords="data", fontsize=17, color=color1)
sax.annotate(str(np.around(stwp.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.06), xycoords="data", fontsize=17, color=color2)
sax.annotate(str(np.around(stwp.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.06), xycoords="data", fontsize=17, color=color3)
sax.annotate(str(np.around(stwp.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.06), xycoords="data", fontsize=17, color=color0)

cax.annotate("4%", xy=(3.1,0.068), xycoords="data", fontsize=17, color=color1)
cax.annotate("28%", xy=(1.7,0.068), xycoords="data", fontsize=17, color=color2)
cax.annotate("31%", xy=(-0.1,0.068), xycoords="data", fontsize=17, color=color3)
cax.annotate("38%", xy=(-1.6,0.068), xycoords="data", fontsize=17, color=color0)
nax.annotate(str(np.around(nshl.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.068), xycoords="data", fontsize=17, color=color1)
nax.annotate(str(np.around(nshl.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.068), xycoords="data", fontsize=17, color=color2)
nax.annotate(str(np.around(nshl.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.068), xycoords="data", fontsize=17, color=color3)
nax.annotate(str(np.around(nshl.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.068), xycoords="data", fontsize=17, color=color0)
fax.annotate(str(np.around(fshl.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.068), xycoords="data", fontsize=17, color=color1)
fax.annotate(str(np.around(fshl.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.068), xycoords="data", fontsize=17, color=color2)
fax.annotate(str(np.around(fshl.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.068), xycoords="data", fontsize=17, color=color3)
fax.annotate(str(np.around(fshl.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.068), xycoords="data", fontsize=17, color=color0)
iax.annotate(str(np.around(ishl.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.068), xycoords="data", fontsize=17, color=color1)
iax.annotate(str(np.around(ishl.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.068), xycoords="data", fontsize=17, color=color2)
iax.annotate(str(np.around(ishl.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.068), xycoords="data", fontsize=17, color=color3)
iax.annotate(str(np.around(ishl.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.068), xycoords="data", fontsize=17, color=color0)
sax.annotate(str(np.around(sshl.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.068), xycoords="data", fontsize=17, color=color1)
sax.annotate(str(np.around(sshl.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.068), xycoords="data", fontsize=17, color=color2)
sax.annotate(str(np.around(sshl.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.068), xycoords="data", fontsize=17, color=color3)
sax.annotate(str(np.around(sshl.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.068), xycoords="data", fontsize=17, color=color0)
...
nax.annotate(str(np.around(nnau.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", fontsize=17, color=color1)
nax.annotate(str(np.around(nnau.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", fontsize=17, color=color2)
nax.annotate(str(np.around(nnau.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", fontsize=17, color=color3)
nax.annotate(str(np.around(nnau.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", fontsize=17, color=color0)
fax.annotate(str(np.around(fnau.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", fontsize=17, color=color1)
fax.annotate(str(np.around(fnau.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", fontsize=17, color=color2)
fax.annotate(str(np.around(fnau.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", fontsize=17, color=color3)
fax.annotate(str(np.around(fnau.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", fontsize=17, color=color0)
iax.annotate(str(np.around(inau.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", fontsize=17, color=color1)
iax.annotate(str(np.around(inau.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", fontsize=17, color=color2)
iax.annotate(str(np.around(inau.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", fontsize=17, color=color3)
iax.annotate(str(np.around(inau.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", fontsize=17, color=color0)
sax.annotate(str(np.around(snau.freq.CAT1)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", fontsize=17, color=color1)
sax.annotate(str(np.around(snau.freq.CAT2)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", fontsize=17, color=color2)
sax.annotate(str(np.around(snau.freq.CAT3)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", fontsize=17, color=color3)
sax.annotate(str(np.around(snau.freq.CS)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", fontsize=17, color=color0)
