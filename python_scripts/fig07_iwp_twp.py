...
def ax_ttl_cat_hist(ttliwp1, ttliwp2, ttliwp3, model, region, ax=None, fs=14):
...
#     ax.set_ylabel(model+'\nFraction of Profiles')
    ax.legend(fontsize=fs-3, frameon=False, loc=1)
    return ax
...
def main():
    ...
    cax.annotate(str(np.round(ccat1,0)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", color="k", fontsize=fs)
    cax.annotate(str(np.round(ccat2,0)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", color="k", fontsize=fs)
    cax.annotate(str(np.round(ccat3,0)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", color="k", fontsize=fs)
    cax.annotate(str(np.round(ccat0,0)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", color="k", fontsize=fs)
    cax.annotate("CAT 1", xy=(3.1,0.062), xycoords="data", color="k", fontsize=fs)
    cax.annotate("CAT 2", xy=(1.7,0.062), xycoords="data", color="k", fontsize=fs)
    cax.annotate("CAT 3", xy=(-0.1,0.062), xycoords="data", color="k", fontsize=fs)
    cax.annotate("Cirrus-free", xy=(-2.4,0.062), xycoords="data", color="k", fontsize=fs)
    ...
    fax.annotate(str(np.round(fcat1,0)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", color="k", fontsize=fs)
    fax.annotate(str(np.round(fcat2,0)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", color="k", fontsize=fs)
    fax.annotate(str(np.round(fcat3,0)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", color="k", fontsize=fs)
    fax.annotate(str(np.round(fcat0,0)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", color="k", fontsize=fs)
    fax.annotate("CAT 1", xy=(3.1,0.062), xycoords="data", color="k", fontsize=fs)
    fax.annotate("CAT 2", xy=(1.7,0.062), xycoords="data", color="k", fontsize=fs)
    fax.annotate("CAT 3", xy=(-0.1,0.062), xycoords="data", color="k", fontsize=fs)
    fax.annotate("Cirrus-free", xy=(-2.4,0.062), xycoords="data", color="k", fontsize=fs)
    ...
    iax.annotate(str(np.round(icat1,0)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", color="k", fontsize=fs)
    iax.annotate(str(np.round(icat2,0)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", color="k", fontsize=fs)
    iax.annotate(str(np.round(icat3,0)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", color="k", fontsize=fs)
    iax.annotate(str(np.round(icat0,0)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", color="k", fontsize=fs)
    iax.annotate("CAT 1", xy=(3.1,0.062), xycoords="data", color="k", fontsize=fs)
    iax.annotate("CAT 2", xy=(1.7,0.062), xycoords="data", color="k", fontsize=fs)
    iax.annotate("CAT 3", xy=(-0.1,0.062), xycoords="data", color="k", fontsize=fs)
    iax.annotate("Cirrus-free", xy=(-2.4,0.062), xycoords="data", color="k", fontsize=fs)
    ...
    sax.annotate(str(np.round(scat1,0)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", color="k", fontsize=fs)
    sax.annotate(str(np.round(scat2,0)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", color="k", fontsize=fs)
    sax.annotate(str(np.round(scat3,0)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", color="k", fontsize=fs)
    sax.annotate(str(np.round(scat0,0)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", color="k", fontsize=fs)
    sax.annotate("CAT 1", xy=(3.1,0.062), xycoords="data", color="k", fontsize=fs)
    sax.annotate("CAT 2", xy=(1.7,0.062), xycoords="data", color="k", fontsize=fs)
    sax.annotate("CAT 3", xy=(-0.1,0.062), xycoords="data", color="k", fontsize=fs)
    ...
    nax.annotate(str(np.round(ncat1,0)).split(".")[0]+"%", xy=(3.1,0.052), xycoords="data", color="k", fontsize=fs)
    nax.annotate(str(np.round(ncat2,0)).split(".")[0]+"%", xy=(1.7,0.052), xycoords="data", color="k", fontsize=fs)
    nax.annotate(str(np.round(ncat3,0)).split(".")[0]+"%", xy=(-0.1,0.052), xycoords="data", color="k", fontsize=fs)
    nax.annotate(str(np.round(ncat0,0)).split(".")[0]+"%", xy=(-1.6,0.052), xycoords="data", color="k", fontsize=fs)
    nax.annotate("CAT 1", xy=(3.1,0.062), xycoords="data", color="k", fontsize=fs)
    nax.annotate("CAT 2", xy=(1.7,0.062), xycoords="data", color="k", fontsize=fs)
    nax.annotate("CAT 3", xy=(-0.1,0.062), xycoords="data", color="k", fontsize=fs)
    nax.annotate("Cirrus-free", xy=(-2.4,0.062), xycoords="data", color="k", fontsize=fs)
