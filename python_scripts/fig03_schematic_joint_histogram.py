...
c = ['C0', 'teal', 'skyblue', 'darkslategray', 'coral']
c0 = c[0]
c1 = c[1]
c2 = c[2]
c3 = c[3]
...
cs = mpat.Ellipse((260,0.1),80,0.1, alpha=0.9, ec=c4, fc=None, fill=False, lw=3)
...
plt.annotate("Clear Sky", xy=(235,0.07),xycoords='data',fontsize=fs-2, color=c4)
