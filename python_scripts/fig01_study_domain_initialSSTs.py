...
ax.set_xticks(np.arange(-10,181,10), minor=False)
ax.set_yticks(np.arange(-20,21,5), minor=False)
...
ax.set_title("")
plt.savefig('../plots/fig01_study_domains.png',dpi=200, bbox_inches="tight")
print("saved as ../plots/fig01_study_domains.png")
plt.close()
