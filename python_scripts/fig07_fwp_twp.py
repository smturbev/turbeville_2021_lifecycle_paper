...
def main(fs = 14):
    ...
    cax.annotate(str(np.round(ccat2,0)).split(".")[0]+"%", xy=(1.4,0.052), xycoords="data", color="k", fontsize=fs-2)
    cax.annotate(str(np.round(ccat3,0)).split(".")[0]+"%", xy=(-0.5,0.052), xycoords="data", color="k", fontsize=fs-2)
    cax.annotate(str(np.round(ccat0,0)).split(".")[0]+"%", xy=(-2.45,0.052), xycoords="data", color="k", fontsize=fs-2)
    cax.annotate("CAT 1", xy=(3.,0.062), xycoords="data", color="k", fontsize=fs-2)
    cax.annotate("CAT 2", xy=(1.3,0.062), xycoords="data", color="k", fontsize=fs-2)
    cax.annotate("CAT 3", xy=(-0.6,0.062), xycoords="data", color="k", fontsize=fs-2)
    cax.annotate("None", xy=(-2.5,0.062), xycoords="data", color="k", fontsize=fs-2)
#     cax.set_title(REGION, size=fs)
    cax.set_xticklabels([])
    cax.set_ylabel("Fraction of profiles\nDARDAR", fontsize=fs)
    ...
    fax.annotate(str(np.round(fcat2,0)).split(".")[0]+"%", xy=(1.4,0.052), xycoords="data", color="k", fontsize=fs-2)
    fax.annotate(str(np.round(fcat3,0)).split(".")[0]+"%", xy=(-0.5,0.052), xycoords="data", color="k", fontsize=fs-2)
    fax.annotate(str(np.round(fcat0,0)).split(".")[0]+"%", xy=(-2.45,0.052), xycoords="data", color="k", fontsize=fs-2)
    fax.annotate("CAT 1", xy=(3.,0.062), xycoords="data", color="k", fontsize=fs-2)
    fax.annotate("CAT 2", xy=(1.3,0.062), xycoords="data", color="k", fontsize=fs-2)
    fax.annotate("CAT 3", xy=(-0.6,0.062), xycoords="data", color="k", fontsize=fs-2)
    fax.annotate("None", xy=(-2.5,0.062), xycoords="data", color="k", fontsize=fs-2)
    fax.set_xticklabels([])
    fax.set_ylabel("Fraction of profiles\nFV3", fontsize=fs)
    ...
    iax.annotate(str(np.round(icat2,0)).split(".")[0]+"%", xy=(1.4,0.052), xycoords="data", color="k", fontsize=fs-2)
    iax.annotate(str(np.round(icat3,0)).split(".")[0]+"%", xy=(-0.5,0.052), xycoords="data", color="k", fontsize=fs-2)
    iax.annotate(str(np.round(icat0,0)).split(".")[0]+"%", xy=(-2.45,0.052), xycoords="data", color="k", fontsize=fs-2)
    iax.annotate("CAT 1", xy=(3.,0.062), xycoords="data", color="k", fontsize=fs-2)
    iax.annotate("CAT 2", xy=(1.3,0.062), xycoords="data", color="k", fontsize=fs-2)
    iax.annotate("CAT 3", xy=(-0.6,0.062), xycoords="data", color="k", fontsize=fs-2)
    iax.annotate("None", xy=(-2.5,0.062), xycoords="data", color="k", fontsize=fs-2)
    iax.set_xticklabels([])
    iax.set_ylabel("Fraction of profiles\nICON", fontsize=fs)
    ...
    sax.annotate(str(np.round(scat2,0)).split(".")[0]+"%", xy=(1.4,0.052), xycoords="data", color="k", fontsize=fs-2)
    sax.annotate(str(np.round(scat3,0)).split(".")[0]+"%", xy=(-0.5,0.052), xycoords="data", color="k", fontsize=fs-2)
    sax.annotate(str(np.round(scat0,0)).split(".")[0]+"%", xy=(-2.45,0.052), xycoords="data", color="k", fontsize=fs-2)
    sax.annotate("CAT 1", xy=(3.,0.062), xycoords="data", color="k", fontsize=fs-2)
    sax.annotate("CAT 2", xy=(1.3,0.062), xycoords="data", color="k", fontsize=fs-2)
    sax.annotate("CAT 3", xy=(-0.6,0.062), xycoords="data", color="k", fontsize=fs-2)
    sax.annotate("None", xy=(-2.5,0.062), xycoords="data", color="k", fontsize=fs-2)
    sax.set_xlabel("log$_{10}$FWP (g/m$^2$)", fontsize=fs)
    sax.set_ylabel("Fraction of profiles\nSAM", fontsize=fs)
    ...
    nax.annotate(str(np.round(ncat2,0)).split(".")[0]+"%", xy=(1.4,0.052), xycoords="data", color="k", fontsize=fs-2)
    nax.annotate(str(np.round(ncat3,0)).split(".")[0]+"%", xy=(-0.5,0.052), xycoords="data", color="k", fontsize=fs-2)
    nax.annotate(str(np.round(ncat0,0)).split(".")[0]+"%", xy=(-2.45,0.052), xycoords="data", color="k", fontsize=fs-2)
    nax.annotate("CAT 1", xy=(3.,0.062), xycoords="data", color="k", fontsize=fs-2)
    nax.annotate("CAT 2", xy=(1.3,0.062), xycoords="data", color="k", fontsize=fs-2)
    nax.annotate("CAT 3", xy=(-0.6,0.062), xycoords="data", color="k", fontsize=fs-2)
    nax.annotate("None", xy=(-2.5,0.062), xycoords="data", color="k", fontsize=fs-2)
    nax.set_xticklabels([])
    nax.set_ylabel("Fraction of profiles\nNICAM", fontsize=fs)
    ...
    cax.annotate("(a)", xy=(-0.1,1.1), xycoords="axes fraction", color="k", fontsize=fs, weight="bold")
    nax.annotate("(b)", xy=(-0.1,1.1), xycoords="axes fraction", color="k", fontsize=fs, weight="bold")
    fax.annotate("(c)", xy=(-0.1,1.1), xycoords="axes fraction", color="k", fontsize=fs, weight="bold")
    iax.annotate("(d)", xy=(-0.1,1.1), xycoords="axes fraction", color="k", fontsize=fs, weight="bold")
    sax.annotate("(e)", xy=(-0.1,1.1), xycoords="axes fraction", color="k", fontsize=fs, weight="bold")
