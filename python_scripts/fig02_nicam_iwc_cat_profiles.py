...
a = 0.4
lw = 3
ax1.plot(dd_iwc1, dd_z/f, 'blueviolet', lw=lw)
ax2.plot(dd_iwc2, dd_z/f, 'blueviolet', lw=lw)
ax3.plot(dd_iwc3, dd_z/f, 'blueviolet', lw=lw)
...
ax3.legend(bbox_to_anchor=(1.1,0.4), fontsize=fs-4,)
ax1.grid(axis='y')
ax2.grid(axis='y')
ax3.grid(axis='y')
...
plt.savefig("../plots/fig02_nicam_cat_iwc_twpnaushl.png", dpi=150, bbox_inches="tight")
print("... saved as ../plots/fig02_nicam_cat_iwc_twpnaushl.png")
plt.show()
