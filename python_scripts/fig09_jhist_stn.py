...
sax.set_ylabel(None)
sax.set_xlabel(None)
cax.annotate("(f)", xy=(-0.15,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
nax.annotate("(g)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
fax.annotate("(h)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
iax.annotate("(i)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
sax.annotate("(j)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
...
cax.annotate("(a)", xy=(-0.15,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
nax.annotate("(b)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
fax.annotate("(c)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
iax.annotate("(d)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
sax.annotate("(e)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
...
cax.annotate("(k)", xy=(-0.15,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
nax.annotate("(l)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
fax.annotate("(m)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
iax.annotate("(n)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
sax.annotate("(o)", xy=(-0.1,1.1), xycoords="axes fraction", fontsize=fs, weight="bold")
...
fig.suptitle(" ")
plt.savefig("../plots/fig09_jhist_stn.png")
print("... saved in ../plots/fig09_jhist_stn.png")
plt.close()
